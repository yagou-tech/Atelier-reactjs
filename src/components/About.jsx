                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <a href="/" class="thumb-menu">
                                            <img class="img-fluid img-cover" src={hero1} alt='' />
                                    ...
                                    <div class="col-4">
                                        <a href="/" class="thumb-menu">
                                            <img class="img-fluid img-cover" src={hero3} alt='' />
                                            <h6>Australian Organic Beef</h6>
                                        </a>
                                    </div>
                                </div>
